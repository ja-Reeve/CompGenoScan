...
### 28/11/2018
### Population: NsNUn Sequencing lane 2
...
$BWA mem -t 4 -M $DATA_REF/ninespine_genome_draft \
	$DATA_TRIM/HI.4883.002.NsNUn_1P \
	$DATA_TRIM/HI.4883.002.NsNUn_2P \
	| $SAMTOOLS sort -o $DATA_BAM/HI.4883.002.NsNUn.bam >> $LOG_PATH/NsNUn.2.bwa_mem.log 2>&1
...
java -XX:ParallelGCThreads=4 -Xmx8G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD AddOrReplaceReadGroups \
  I=$DATA_BAM/HI.4883.002.NsNUn.bam \
  O=$DATA_BAM/HI.4883.002.NsNUn_sort.bam \
  RGID=Index_28 \
  ...
  RGDT=2018-11-12 \
  RGPI=150 >> $LOG_PATH/NsNUn.2.ReadInfo.log 2>&1

## Mark duplicates
java -XX:ParallelGCThreads=4 -Xmx8G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD MarkDuplicates \
  I=$DATA_BAM/HI.4883.002.NsNUn_sort.bam \
  O=$DATA_BAM/HI.4883.002.NsNUn_DupMark.bam \
  M=$DATA_HOME/HI.4883.002.NsNUn_duplicate_metrics.txt \
  OPTICAL_DUPLICATE_PIXEL_DISTANCE=2500 \
MAX_FILE_HANDLES_FOR_READ_ENDS_MAP=1000 \
CREATE_INDEX=true >> $LOG_PATH/NsNUn.2.MarkDuplicates.log 2>&1

## Error Check
java -XX:ParallelGCThreads=4 -Xmx8G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD ValidateSamFile \
  I=$DATA_BAM/HI.4883.002.NsNUn_DupMark.bam \
  MAX_OPEN_TEMP_FILES=1000 \
  MODE=SUMMARY >> $LOG_PATH/NsNUn.2.ValidateSamFile.log 2>&1
