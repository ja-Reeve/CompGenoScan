...
### 23/4/2018
### Population: NsNUd Sequencing lane 2
...
java -jar $Trimmomatic PE -threads 18 -phred33 \
 $DATA_FASTQ/HI.4883.002.NsNUd_R1.fastq.gz $DATA_FASTQ/HI.4883.002.NsNUd_R2.fastq.gz \
 -baseout $DATA_TRIM/HI.4883.002.NsNUd \
...
$BWA mem -t 4 -M $DATA_REF/threespine_genome.fa \
        $DATA_TRIM/HI.4883.002.NsNUd_1P \
        $DATA_TRIM/HI.4883.002.NsNUd_2P \
        | $SAMTOOLS sort -o $DATA_BAM/HI.4883.002.NsNUd.bam >> $LOG_PATH/NsNUd.2.bwa_mem.log 2>&1
		
java -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD AddOrReplaceReadGroups \
  I=$DATA_BAM/HI.4883.002.NsNUd.bam \
  O=$DATA_BAM/HI.4883.002.NsNUd_sort.bam \
  ...
  RGDT=2018-11-12 \
  RGPI=150 >> $LOG_PATH/NsNUd.2.sorting.log 2>&1

## Mark duplicates
java -Xmx32G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD MarkDuplicates \
  I=$DATA_BAM/HI.4883.002.NsNUd_sort.bam \
  O=$DATA_BAM/HI.4883.002.NsNUd_DupMark.bam \
  M=$DATA_HOME/HI.4883.002.NsNUd_duplicate_metrics.txt \
  OPTICAL_DUPLICATE_PIXEL_DISTANCE=2500 \
  CREATE_INDEX=true >> $LOG_PATH/NsNUd.2.MarkDuplicates.log 2>&1

## Error Check
java -Xmx32G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD ValidateSamFile \
      I=$DATA_BAM/HI.4883.002.NsNUd_DupMark.bam \
      MODE=SUMMARY >> $LOG_PATH/NsNUd.2.ValidateSamFile.log 2>&1
