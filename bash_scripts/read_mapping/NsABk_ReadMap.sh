...
### 28/11/2018
### Population: NsABk Sequencing lane 1
...
java -jar $Trimmomatic PE -threads 18 -phred33 \
 $DATA_FASTQ/HI.4883.001.NsABk_R1.fastq.gz $DATA_FASTQ/HI.4883.001.NsABk_R2.fastq.gz \
 -baseout $DATA_TRIM/HI.4883.001.NsABk \
...
$BWA mem -t 4 -M $DATA_REF/ninespine_genome_draft \
	$DATA_TRIM/HI.4883.001.NsABk_1P \
	$DATA_TRIM/HI.4883.001.NsABk_2P \
	| $SAMTOOLS sort -o $DATA_BAM/HI.4883.001.NsABk.bam >> $LOG_PATH/NsABk.1.bwa_mem.log 2>&1
...
java -XX:ParallelGCThreads=4 -Xmx8G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD AddOrReplaceReadGroups \
  I=$DATA_BAM/HI.4883.001.NsABk.bam \
  O=$DATA_BAM/HI.4883.001.NsABk_sort.bam \
  RGID=Index_52 \
  ...
  RGDT=2018-11-12 \
  RGPI=150 >> $LOG_PATH/NsABk.1.ReadInfo.log 2>&1

## Mark duplicates
java -XX:ParallelGCThreads=4 -Xmx8G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD MarkDuplicates \
  I=$DATA_BAM/HI.4883.001.NsABk_sort.bam \
  O=$DATA_BAM/HI.4883.001.NsABk_DupMark.bam \
  M=$DATA_HOME/HI.4883.001.NsABk_duplicate_metrics.txt \
  OPTICAL_DUPLICATE_PIXEL_DISTANCE=2500 \
  MAX_FILE_HANDLES_FOR_READ_ENDS_MAP=1000 \
  CREATE_INDEX=true >> $LOG_PATH/NsABk.1.MarkDuplicates.log 2>&1

## Error Check
java -XX:ParallelGCThreads=4 -Xmx8G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD ValidateSamFile \
  I=$DATA_BAM/HI.4883.001.NsABk_DupMark.bam \
  MAX_OPEN_TEMP_FILES=1000 \
  MODE=SUMMARY >> $LOG_PATH/NsABk.1.ValidateSamFile.log 2>&1
