...
### 23/4/2018
### Population: NsABm Sequencing lane 2
...
java -jar $Trimmomatic PE -threads 18 -phred33 \
 $DATA_FASTQ/HI.4883.002.NsABm_R1.fastq.gz $DATA_FASTQ/HI.4883.002.NsABm_R2.fastq.gz \
 -baseout $DATA_TRIM/HI.4883.002.NsABm \
 ILLUMINACLIP:TruSeq3-SE.fa:2:30:10 MINLEN:120

## Read mapping with BWA-MEM
$BWA mem -t 4 -M $DATA_REF/threespine_genome.fa \
        $DATA_TRIM/HI.4883.002.NsABm_1P \
        $DATA_TRIM/HI.4883.002.NsABm_2P \
        | $SAMTOOLS sort -o $DATA_BAM/HI.4883.002.NsABm.bam >> $LOG_PATH/NsABm.2.bwa_mem.log 2>&1
		
java -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD AddOrReplaceReadGroups \
  I=$DATA_BAM/HI.4883.002.NsABm.bam \
  O=$DATA_BAM/HI.4883.002.NsABm_sort.bam \
  RGID=Index_36 \
  ...
  RGDT=2018-11-12 \
  RGPI=150 >> $LOG_PATH/NsABm.2.sorting.log 2>&1

## Mark duplicates
java -Xmx32G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD MarkDuplicates \
  I=$DATA_BAM/HI.4883.002.NsABm_sort.bam \
  O=$DATA_BAM/HI.4883.002.NsABm_DupMark.bam \
  M=$DATA_HOME/HI.4883.002.NsABm_duplicate_metrics.txt \
  OPTICAL_DUPLICATE_PIXEL_DISTANCE=2500 \
  CREATE_INDEX=true >> $LOG_PATH/NsABm.2.MarkDuplicates.log 2>&1

## Error Check
java -Xmx32G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD ValidateSamFile \
      I=$DATA_BAM/HI.4883.002.NsABm_DupMark.bam \
      MODE=SUMMARY >> $LOG_PATH/NsABm.2.ValidateSamFile.log 2>&1
