...
#-I $DATA_BAM/NsABk_DupMark.bam \
#-o $DATA_HOME/NsABk_Indel.vcf \
#-out_mode EMIT_ALL_SITES \
#-ploidy 60 \
#| $BCFTOOLS view -v indels $DATA_HOME/NsABk_Indel.vcf >> $LOG_PATH/NsABk.IndelCall.log 2>&1

## Create Target Sites for Realignment
java -XX:ParallelGCThreads=4 -Xmx32G -Djava.io.tmpdir=/data/home/james/tmp -jar $GATK3 \
-T RealignerTargetCreator \
-R $DATA_REF/threespine_genome.fa \
-I $DATA_BAM/Old/NsABk_DupMark.bam \
-o $DATA_HOME/NsABk_realignment_sites2.list >> $LOG_PATH/NsABk.RealigmentSet2.log 2>&1

## Realign Reads
java -XX:ParallelGCThreads=4 -Xmx32G -Djava.io.tmpdir=/data/home/james/tmp -jar $GATK3 \
-T IndelRealigner \
-R $DATA_REF/threespine_genome.fa \
-targetIntervals $DATA_HOME/NsABk_realignment_sites2.list \
-I $DATA_BAM/Old/NsABk_DupMark.bam \
-o $DATA_BAM/NsABk_Realign2.bam >> $LOG_PATH/NsABk.IndelRealigner2.log 2>&1

## Error Check
java -XX:ParallelGCThreads=4 -Xmx32G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD ValidateSamFile \
      I=$DATA_BAM/NsABk_Realign2.bam \
      MAX_OPEN_TEMP_FILES=1000 \
      MODE=SUMMARY >> $LOG_PATH/NsABk.ValidateRealignBam2.log 2>&1
