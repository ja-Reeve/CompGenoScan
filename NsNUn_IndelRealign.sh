...
#-I $DATA_BAM/NsNUn_DupMark.bam \
#-o $DATA_HOME/NsNUn_Indel.vcf \
#-out_mode EMIT_ALL_SITES \
#-ploidy 92 \
#| $BCFTOOLS view -v indels $DATA_HOME/NsNUn_Indel.vcf >> $LOG_PATH/NsNUn.IndelCall.log 2>&1

## Create Target Sites for Realignment
java -XX:ParallelGCThreads=4 -Xmx16G -Djava.io.tmpdir=/data/home/james/tmp -jar $GATK3 \
-T RealignerTargetCreator \
-R $DATA_REF/ninespine_genome_draft.fasta \
-I $DATA_BAM/NsNUn_DupMark.bam \
-o $DATA_HOME/NsNUn_realignment_sites.list >> $LOG_PATH/NsNUn.RealigmentSet.log 2>&1

## Realign Reads
java -XX:ParallelGCThreads=4 -Xmx16G -Djava.io.tmpdir=/data/home/james/tmp -jar $GATK3 \
-T IndelRealigner \
-R $DATA_REF/ninespine_genome_draft.fasta \
-targetIntervals $DATA_HOME/NsNUn_realignment_sites.list \
-I $DATA_BAM/NsNUn_DupMark.bam \
-o $DATA_BAM/NsNUn_Realign.bam >> $LOG_PATH/NsNUn.IndelRealigner.log 2>&1

## Error Check
java -XX:ParallelGCThreads=4 -Xmx16G -Djava.io.tmpdir=/data/home/james/tmp -jar $PICARD ValidateSamFile \
      I=$DATA_BAM/NsNUn_Realign.bam \
      MAX_OPEN_TEMP_FILES=1000 \
      MODE=SUMMARY >> $LOG_PATH/NsNUn.ValidateRealignBam.log 2>&1
